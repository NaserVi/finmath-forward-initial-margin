...
public class LMMCalibrationTest {
	...
	public void testATMSwaptionCalibration() throws CalculationException {
		...
		DiscountCurve discountCurve = DiscountCurveInterpolation.createDiscountCurveFromDiscountFactors("discountCurve",
				// Times
		...
		LIBORCorrelationModel correlationModel = new LIBORCorrelationModelExponentialDecay(timeDiscretizationFromArray, liborPeriodDiscretization, numberOfFactors, 0.04, true);
