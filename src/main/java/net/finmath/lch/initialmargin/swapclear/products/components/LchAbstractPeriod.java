 ...
 * @version 1.1
 */
public abstract class LchAbstractPeriod extends AbstractProductComponent {
	...
	private final LchNotional					notional;
	 ...
	 */
	public LchAbstractPeriod(final LocalDateTime referenceDate, final double periodStart, final double periodEnd,
			final double fixingDate, final double paymentDate, final LchNotional notional,
	 ...
	 * @param daycountFraction The daycount fraction (<code>coupon = index(fixingDate) * daycountFraction</code>).
	 */
	public LchAbstractPeriod(final double periodStart, final double periodEnd,
			final double fixingDate, final double paymentDate, final LchNotional notional,
			final AbstractProductComponent index, final double daycountFraction) {
	 ...
	 */
	public LchNotional getNotional() {
		return notional;
	}
