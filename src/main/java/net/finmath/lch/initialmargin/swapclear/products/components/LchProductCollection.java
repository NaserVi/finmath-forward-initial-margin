 ...
 * @version 1.1
 */
public class LchProductCollection extends AbstractProductComponent {
	 ...
	 */
	public LchProductCollection(final AbstractProductComponent... products) {
	 ...
	 */
	public LchProductCollection(final Collection<AbstractProductComponent> products) {
		super();
	...
	public RandomVariable getValue(final LocalDateTime evaluationDate, final LocalDateTime scheduleReferenceDate, final ZeroRateModel forwardCurveModel, final StochasticCurve forwardCurveShifts, final ZeroRateModel discountCurveModel, final StochasticCurve discountCurveShifts, Integer pathOrState) throws CalculationException {
		...
		for(final MonteCarloProduct product : products) {
			values = values.add(((LchPeriod) product).getValue(evaluationDate, scheduleReferenceDate, forwardCurveModel, forwardCurveShifts, discountCurveModel, discountCurveShifts, pathOrState));
		}
		return values;
	}
